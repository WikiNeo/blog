...
1. a large ship
2. the Ark in the Bible, the large boat built by Noah to save his family and
   the animals from a flood that overed the earth.
...
2. [countable usually singular] a statement by someone in a court of law saying
...
3. [usually + adverb/preposition] if a large amount of a liquid, electricity,
   chemical etc surges, it moves very quickly and suddenly
...
2. [intransitive always + adverb/preposition] British English to pull a piece
   of clothing quickly onto your body
   1. tug something on
