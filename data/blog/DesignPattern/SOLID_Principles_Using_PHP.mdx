...
_Depend on abstraction, not on concretions_. This snippet above violates this
...
the `PasswordReminder` class, and this would violate the _open-close principle_.
