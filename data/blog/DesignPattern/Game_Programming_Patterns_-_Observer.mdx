...
_without actually caring who receives the notification._
...
The important bit is that the subject exposes a _public_ API from modifying that list:
...
In real code, I would avoid using inheritance here. Instead, I'd make `Physics` _have_ an
...
former, you observer _the thing what did something interesting_. With the latter, you
