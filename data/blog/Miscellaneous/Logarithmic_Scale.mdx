...
tags: [Miscellaneous]
date: 2025-06-27
summary: A **log scale** (short for **logarithmic scale**) is a way of displaying numerical data that uses the **logarithm of values** instead of the values themselves.
---
