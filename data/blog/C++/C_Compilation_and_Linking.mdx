...
The preprocessor handles the _preprocessor directives_, like `#include` and `#define`. It
...
you don't need to recomiple _everything_ if you only change a single file.
