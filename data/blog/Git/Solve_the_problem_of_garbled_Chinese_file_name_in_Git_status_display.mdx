...
tags: [Git]
date: 2022-04-05
summary: When using git status to view the changed but uncommitted Chinese file name, it is found that it will be displayed as a string of numbers, and the Chinese file name is not displayed.
---
