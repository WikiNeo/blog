...
export default function RandomBlogButton() {
  ...
  return (
    <button
      ...
      disabled={loading}
      className="bg-primary-500 hover:bg-primary-700 focus:ring-primary-500 rounded-full px-4 py-2 text-sm font-medium text-white transition-colors focus:ring-2 focus:ring-offset-2 focus:outline-none disabled:cursor-not-allowed disabled:opacity-50"
    >
